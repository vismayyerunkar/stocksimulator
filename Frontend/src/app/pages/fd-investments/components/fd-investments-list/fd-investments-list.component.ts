...
@Component({
  selector: 'app-fd-investments-list',
  templateUrl: './fd-investments-list.component.html',
  styleUrls: ['./fd-investments-list.component.scss'],
})
export class FdInvestmentsListComponent implements OnInit {
